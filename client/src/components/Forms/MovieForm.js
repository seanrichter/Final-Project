              ...
              <Form>
                ...
                <Form.Group controlId="formDirector">
                  ...
                  <Form.Control
                    ...
                    isValid={this.state.director.length}
                  />
                ...
                <Form.Group controlId="formYear">
                  ...
                  <Form.Control
                    ...
                    onChange={this.handleInputChange}
                    placeholder="Enter the year of the film's release"
                    isValid={(parseInt(this.state.year) + "").length === 4}
                    isInvalid={!((parseInt(this.state.year) + "").length === 4)}
                  />
                ...
                <Form.Group controlId="formImage">
                  ...
                  <Form.Control
                    ...
                    onChange={this.handleInputChange}
                    placeholder="Enter a url of an image from this film"
                  />
                  <Form.Text className="text-muted"></Form.Text>
                </Form.Group>
                  ...
                  <ListGroup variant="flush">
                    {this.state.movies.map(movie => (
                      <MovieDetailModal
                        key={movie._id}
                        movie={movie}
                        deleteFunction={this.deleteMovie}
                      />
                    ))}
                  </ListGroup>
                </Card>
